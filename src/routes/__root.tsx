  ...
  head: () => ({
    meta: [
      ...
      { title: "MediaDrop — Free AI Tools for Content Creators" },
      {
        name: "description",
        content:
          "Free AI and image tools for YouTubers, TikTokers and social marketers: titles, captions, hashtags, image compression and resizing.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "MediaDrop",
          description: "Free AI and image tools for content creators.",
        }),
      },
    ],
  }),
